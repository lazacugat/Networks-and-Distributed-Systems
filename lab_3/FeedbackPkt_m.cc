...
{
    this->bufferFull = other.bufferFull;
    this->bufferFeedbackFull = other.bufferFeedbackFull;
}

void FeedbackPkt::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::omnetpp::cPacket::parsimPack(b);
    doParsimPacking(b,this->bufferFull);
    doParsimPacking(b,this->bufferFeedbackFull);
}

void FeedbackPkt::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cPacket::parsimUnpack(b);
    doParsimUnpacking(b,this->bufferFull);
    doParsimUnpacking(b,this->bufferFeedbackFull);
}

bool FeedbackPkt::getBufferFull() const
{
    return this->bufferFull;
}

void FeedbackPkt::setBufferFull(bool bufferFull)
{
    this->bufferFull = bufferFull;
}

bool FeedbackPkt::getBufferFeedbackFull() const
{
    return this->bufferFeedbackFull;
}

void FeedbackPkt::setBufferFeedbackFull(bool bufferFeedbackFull)
{
    this->bufferFeedbackFull = bufferFeedbackFull;
}
...
unsigned int FeedbackPktDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISEDITABLE,    // FIELD_bufferFull
        FD_ISEDITABLE,    // FIELD_bufferFeedbackFull
    };
...
int FeedbackPktDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "bufferFull") == 0) return baseIndex + 0;
    if (strcmp(fieldName, "bufferFeedbackFull") == 0) return baseIndex + 1;
...
const char *FeedbackPktDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "bool",    // FIELD_bufferFull
        "bool",    // FIELD_bufferFeedbackFull
    };
...
std::string FeedbackPktDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    FeedbackPkt *pp = omnetpp::fromAnyPtr<FeedbackPkt>(object); (void)pp;
    switch (field) {
        case FIELD_bufferFull: return bool2string(pp->getBufferFull());
        case FIELD_bufferFeedbackFull: return bool2string(pp->getBufferFeedbackFull());
        default: return "";
    }
}
...
void FeedbackPktDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    FeedbackPkt *pp = omnetpp::fromAnyPtr<FeedbackPkt>(object); (void)pp;
    switch (field) {
        case FIELD_bufferFull: pp->setBufferFull(string2bool(value)); break;
        case FIELD_bufferFeedbackFull: pp->setBufferFeedbackFull(string2bool(value)); break;
...
omnetpp::cValue FeedbackPktDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    FeedbackPkt *pp = omnetpp::fromAnyPtr<FeedbackPkt>(object); (void)pp;
    switch (field) {
        case FIELD_bufferFull: return pp->getBufferFull();
        case FIELD_bufferFeedbackFull: return pp->getBufferFeedbackFull();
...
void FeedbackPktDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    FeedbackPkt *pp = omnetpp::fromAnyPtr<FeedbackPkt>(object); (void)pp;
    switch (field) {
        case FIELD_bufferFull: pp->setBufferFull(value.boolValue()); break;
        case FIELD_bufferFeedbackFull: pp->setBufferFeedbackFull(value.boolValue()); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'FeedbackPkt'", field);
    }
}
